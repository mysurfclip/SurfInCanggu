              ...
              <div className="max-w-[700px]">
                ...
                <div className="mt-8 md:mt-10">
                  <Link
                    ...
                    className="inline-flex items-center gap-3 border border-white/30 px-8 py-4 rounded-full text-white transition-all duration-300 hover:bg-white hover:text-primary-forest"
                  >
