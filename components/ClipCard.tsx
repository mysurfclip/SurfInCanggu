...
export default function ClipCard({ clip }: ClipCardProps) {
  return (
    ...
    >
      {/* Thumbnail */}
      <div className="relative aspect-video bg-gradient-to-br from-[#87CEEB] to-[#4682B4]">
        <img
          src={clip.thumbnail}
          alt={clip.title}
        ...
        {/* Duration Badge */}
        <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 bg-[#2c4d48]/90 backdrop-blur-sm text-white text-xs sm:text-sm px-3 py-1.5 rounded-full font-medium">
          {clip.duration}
        </div>
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex items-start justify-between gap-4 mb-3">
          <h3 className="font-normal text-[18px] sm:text-[20px] lg:text-[24px] leading-[1.4] text-[#2c4d48] tracking-[-0.53px] group-hover:text-[#e49355] transition-colors">
            {clip.title}
          </h3>
          <svg className="flex-shrink-0 mt-1 text-[rgba(44,77,72,0.4)] group-hover:text-[#e49355] group-hover:translate-x-1 transition-all" width="16" height="16" viewBox="0 0 16 16" fill="none">
