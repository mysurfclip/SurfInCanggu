...
export default function ClipCard({ clip }: ClipCardProps) {
  return (
    <Link 
      ...
      className="card-hover group block bg-white rounded-2xl overflow-hidden transition-all duration-500"
    >
      {/* Thumbnail */}
      <div className="relative aspect-video bg-gradient-to-br from-[#87CEEB] to-[#4682B4] overflow-hidden image-zoom-wrapper">
        <img
          src={clip.thumbnail}
          alt={clip.title}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:scale-110 transition-all duration-500 shadow-lg">
